...
clients/android/
├── app/
│   ├── build.gradle.kts                      # 模块构建脚本 (versionName 动态读取根 package.json)
│   └── src/main/
│       ├── AndroidManifest.xml
...
- 在 GitHub 仓库的 **[Actions 页面](https://github.com/liguoshuai-1990/pi-chat/actions)** 或 **[Releases 页面](https://github.com/liguoshuai-1990/pi-chat/releases)** 下载 `pi-chat-android-apk` 压缩包解压即可获得 `pi-chat-v<version>-debug.apk`（`<version>` 为当前版本号）。
...
# 生成路径：app/build/outputs/apk/debug/pi-chat-v<version>-debug.apk
